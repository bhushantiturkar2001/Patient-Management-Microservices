  ...
  public LocalStack(final App scope, final String id, final StackProps props){
    ...
    FargateService authService =
        createFargateService("AuthService",
            ...
            List.of(4005),
            authServiceDb,
            Map.of("JWT_SECRET", "d29uZGVyZnVscGxhbmVsYWJvcmJvdGh0aGVlc2V0aGluc3RhcnRuZWFybHljcmU="));
...
//        .kafkaVersion("2.8.0")
//        .numberOfBrokerNodes(2) // change 1 to 2 
...
//  }
  ...
  private CfnCluster createMskCluster() {
	    // Get exactly one private subnet per AZ
	    List<String> privateSubnets = vpc.getPrivateSubnets().stream()
	            .map(ISubnet::getSubnetId)
	            .limit(2) // one subnet per AZ
	            .collect(Collectors.toList());

	    return CfnCluster.Builder.create(this, "MskCluster")
	            .clusterName("kafka-cluster")
	            .kafkaVersion("2.8.0")
	            .numberOfBrokerNodes(2) // Must be divisible by number of AZs (2)
	            .brokerNodeGroupInfo(
